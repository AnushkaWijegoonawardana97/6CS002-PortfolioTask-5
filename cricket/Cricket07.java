...
public class Cricket07 {
    public static void main(String[] args) {
        ...
        // Calculate the sum of squares for "Runs For" using sequential stream
        ...
        System.out.println("Sequential Stream - Sum of squares: " + sumSequential);
        System.out.println("Sequential Stream Time: " + (endTimeSequential - startTimeSequential) + " ms");

        // Calculate the sum of squares for "Runs For" using parallel stream
        ...
        System.out.println("\nParallel Stream - Sum of squares: " + sumParallel);
