...
public class Cricket05 {
    public static void main(String[] args) {
        ...
        System.out.println("Sorted by Comparator in CricketTeam class");
        teams.stream().sorted().forEach(System.out::println);

        System.out.println();
        System.out.println("Sorted by lambda");
        teams.stream()
                .sorted((t1, t2) -> ((Integer) t1.getRunsAgainst()).compareTo(t2.getRunsAgainst()))
