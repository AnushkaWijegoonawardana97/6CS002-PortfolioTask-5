...
public class Cricket04 {
    public static void main(String[] args) {
        ...
        System.out.println("Several teams have 26 runs difference:");
        teams.stream().filter(team -> team.getRunDifference() == 26)
                .forEach(System.out::println);

        System.out.println();
        System.out.println("Teams with 32 points:");
        teams.stream().filter(team -> team.getPoints() == 32)
                .forEach(System.out::println);
    }
}